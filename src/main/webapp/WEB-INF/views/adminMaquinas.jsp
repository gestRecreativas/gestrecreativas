		...
		<div id="page-wrapper">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-adminMaquinas">
                            </table>
                            <!-- /.table-responsive -->
                        </div>
                        <!-- /.panel-body -->
            ...
            <div class="row">
            	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="text-align:center;">
            		<button type="button" onClick="GotoCreateUpdateMaquina()" class="btn btn-primary btn-xs" style="margin-bottom:10px;">Crear nueva máquina</button>
            	</div>
            </div>
            </div>
		</div>
...
<script>
$(function() {
	if ($("#dataTables-adminMaquinas") != undefined){
		$.get(uriAdminMaquinas, function( data ) {
			var object = data;
			generateRowsTableAdminMaquinas(data);
			FullTable('#dataTables-adminMaquinas', columnSetAdminMaquinas, true);
		})
		.fail(function(err) {
