...
<%
	...
	boolean todos = false;
	if (!StringUtil.isNullOrEmptyString(verTodos) && verTodos.equals("1")){
		todos = true;
	}
%>
<!DOCTYPE html>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-establecimientos">
                            </table>
                            <!-- /.table-responsive -->
                        </div>
                        <!-- /.panel-body -->
...
<script>
$(function() {
	if ($("#dataTables-establecimientos") != undefined){
		var uri = uriEstablecimientosUsuario;
		<% if (todos){ %>
			uri = uriEstablecimientosTotal;
		<% } %>
		$.get( uri, function( data ) {
			var object = data;
			generateRowsTableEstablecimientos(data);
			var textoChecked = '';
			<% if (todos){ %>
				textoChecked = ' checked';
			<% } %>
			FullTable('#dataTables-establecimientos', columnSetEstablecimiento, true);
			$("#dataTables-establecimientos_filter").append('<div class="checkbox"><label><input name="verTodos" id="verTodos" onClick="VerTodosEstablecimientos(this)" value="1" type="checkbox"' + textoChecked + '>Ver todos</label></div>');
		})
		.fail(function(err) {
